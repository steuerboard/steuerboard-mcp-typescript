...
import {
  CreateTaskRequest,
  CreateTaskRequest$zodSchema,
  CreateTaskResponse,
  CreateTaskResponse$zodSchema,
} from "../models/createtaskop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateTaskRequest$zodSchema.parse(value$),
  ...
  >(
    ...
    M.json(400, CreateTaskResponse$zodSchema, {
    ...
    M.json(500, CreateTaskResponse$zodSchema, { key: "internal_error" }),
