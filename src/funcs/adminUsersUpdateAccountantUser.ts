...
import {
  ...
  UpdateAccountantUserRequest$zodSchema,
  UpdateAccountantUserResponse,
  UpdateAccountantUserResponse$zodSchema,
} from "../models/updateaccountantuserop.js";
 ...
 */
export function adminUsersUpdateAccountantUser(
  client$: SteuerboardCore,
  request: UpdateAccountantUserRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateAccountantUserRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.UpdateAccountantUser, {
    explode: true,
  });
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, UpdateAccountantUserResponse$zodSchema, {
      key: "AccountantUser",
    }),
    ...
    M.nil(500, UpdateAccountantUserResponse$zodSchema),
