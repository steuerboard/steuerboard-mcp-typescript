...
import {
  ...
  ListWorkspaceMembersRequest$zodSchema,
  ListWorkspaceMembersResponse,
  ListWorkspaceMembersResponse$zodSchema,
} from "../models/listworkspacemembersop.js";
 ...
 */
export function workspaceMembersListWorkspaceMembers(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListWorkspaceMembersRequest$zodSchema.parse(value$),
  ...
  >(
    ...
    M.json(422, ListWorkspaceMembersResponse$zodSchema, {
      key: "fourHundredAndTwentyTwoApplicationJsonObject",
    }),
    M.json(429, ListWorkspaceMembersResponse$zodSchema, { key: "rate_limit" }),
    M.json(500, ListWorkspaceMembersResponse$zodSchema, {
      key: "internal_error",
    }),
