...
import {
  UpdateTaskRequest,
  UpdateTaskRequest$zodSchema,
  UpdateTaskResponse,
  UpdateTaskResponse$zodSchema,
} from "../models/updatetaskop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateTaskRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.TaskUpdate, { explode: true });
