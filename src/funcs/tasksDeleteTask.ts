...
import {
  DeleteTaskRequest,
  DeleteTaskRequest$zodSchema,
  DeleteTaskResponse,
  DeleteTaskResponse$zodSchema,
} from "../models/deletetaskop.js";
 ...
 */
export function tasksDeleteTask(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteTaskRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, DeleteTaskResponse$zodSchema, { key: "Task" }),
    M.json(400, DeleteTaskResponse$zodSchema, {
    ...
    M.json(500, DeleteTaskResponse$zodSchema, { key: "internal_error" }),
