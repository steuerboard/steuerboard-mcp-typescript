 ...
 */
export function workspacesUpdateWorkspace(
...
> {
  ...
  const body$ = encodeJSON("body", payload$.WorkspaceUpdate, { explode: true });
  ...
  >(
    ...
    M.json(500, UpdateWorkspaceResponse$zodSchema, { key: "internal_error" }),
