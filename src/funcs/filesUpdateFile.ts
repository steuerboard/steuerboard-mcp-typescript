...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateFileRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.FileUpdate, { explode: true });
  ...
  >(
    ...
    M.json(400, UpdateFileResponse$zodSchema, {
    ...
    M.json(500, UpdateFileResponse$zodSchema, { key: "internal_error" }),
