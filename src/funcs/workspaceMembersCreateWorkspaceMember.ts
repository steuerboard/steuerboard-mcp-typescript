...
import {
  ...
  CreateWorkspaceMemberRequest$zodSchema,
  CreateWorkspaceMemberResponse,
  CreateWorkspaceMemberResponse$zodSchema,
} from "../models/createworkspacememberop.js";
 ...
 */
export function workspaceMembersCreateWorkspaceMember(
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateWorkspaceMemberRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.WorkspaceMemberCreate, {
    explode: true,
  });
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, CreateWorkspaceMemberResponse$zodSchema, {
      key: "WorkspaceMember",
    }),
    ...
    M.json(422, CreateWorkspaceMemberResponse$zodSchema, {
      key: "fourHundredAndTwentyTwoApplicationJsonObject",
    }),
    M.json(429, CreateWorkspaceMemberResponse$zodSchema, { key: "rate_limit" }),
    M.json(500, CreateWorkspaceMemberResponse$zodSchema, {
      key: "internal_error",
    }),
