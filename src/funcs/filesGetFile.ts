...
import {
  GetFileRequest,
  GetFileRequest$zodSchema,
  GetFileResponse,
  GetFileResponse$zodSchema,
} from "../models/getfileop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetFileRequest$zodSchema.parse(value$),
  ...
  >(
    ...
    M.json(400, GetFileResponse$zodSchema, {
    ...
    M.json(500, GetFileResponse$zodSchema, { key: "internal_error" }),
