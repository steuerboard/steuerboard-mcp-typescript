...
Install the MCP server as a Desktop Extension using the pre-built [`mcp-server.mcpb`](https://github.com/steuerboard/steuerboard-mcp-typescript/releases/download/v0.4.2/mcp-server.mcpb) file:

Simply drag and drop the [`mcp-server.mcpb`](https://github.com/steuerboard/steuerboard-mcp-typescript/releases/download/v0.4.2/mcp-server.mcpb) file onto Claude Desktop to install the extension.
