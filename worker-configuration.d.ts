/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 49a47de8f8942c795c0e3fc339941fec)
// Runtime types generated with workerd@1.20250913.0 2025-07-15 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		STEUERBOARD_MCP: DurableObjectNamespace<import("./src/cloudflare-worker/cloudflare-worker").SteuerboardMCP>;
		ASSETS: Fetcher;
	}
}
